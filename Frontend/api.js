 ...
 */
const API_BASE = 'https://phys-evening-serving-arc.trycloudflare.com/api/';
...
const Auth = {
  ...
  isLoggedIn() {
    ...
    // JWT expiry check — no server call needed
    try {
...
// For forgot-password and reset-password — avoids 401 from expired token
